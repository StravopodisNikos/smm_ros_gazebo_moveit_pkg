...
int main(int argc, char **argv)
{
    ...
    ft_sensor_data_file.open("/home/nikos/catkin_ws/src/smm_ros_gazebo_moveit_pkg/ft_log.txt", ios::out | ios::app | ios::binary);
    
    ros::init(argc, argv, "torque_sensor1_subscriber");

    ros::NodeHandle n;

    ros::Subscriber sub = n.subscribe("torque_sensor1_topic", 1000, ft_chatter_Callback);

    ft_sensor_data_file.close();
