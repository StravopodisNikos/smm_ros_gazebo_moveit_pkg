...
int main(int argc, char** argv)
{
  ...
  static const std::string PLANNING_GROUP = "smm_arm";
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools("base_plate");
  ...
  ocm.link_name = "massage_tool_2";
  ocm.header.frame_id = "base_plate";
  ...
  move_group_interface.attachObject(object_to_attach.id, "smm_arm");
